package com.fallstudie.cinemasystem.system;
...
//        reservation.setTickets(createTickets());
    ...
    private static List<RatingTo> createRatings ( CustomerTo user )
    {
        List<RatingTo> ratings = new ArrayList<>();
    ...
    private static RatingTo createRating ( CustomerTo user )
    {
        RatingTo rating = new RatingTo();
        rating.setId(1L);
        rating.setComment("Test Comment");
