...
Zusätzlich wird in der \testtt{ReservationResource} das Blockieren und Deblockieren einzelner Sitze ausgeführt. Um dies zu Testen werden zwei Blockierungs-Objekte zu Beginn des Tests angelegt.
...
Dieser wurde ähnlich des \testtt{Posts} der Reservierung umgesetzt, mit dem Nachteil, dass ein löschen eines Filmes im aktuellen Entwicklungsstand nicht möglicht ist. Dies muss per Hand nach dem Test gelöscht werden, da sonst ein Testfilm in der Datenbank steht.
